export const moveUp = (board: number[][]): boolean => {
  let moved = false
...
export const moveDown = (board: number[][]): boolean => {
  let moved = false
...
export const moveLeft = (board: number[][]): boolean => {
  let moved = false
...
export const moveRight = (board: number[][]): boolean => {
  let moved = false
...
export const moveNotPossible = (matrix: number[][]) => {
